...
Working documents, added while building: [accessibility-checklist.md](accessibility-checklist.md) (the manual screen-reader pass), [pilot/](pilot/) — the [leader quick start](pilot/leader-quick-start.md), the [video script](pilot/video-script.md) and the [pilot plan](pilot/pilot-plan.md) — and [runbooks/](runbooks/) for [deployment](runbooks/deployment.md), [recovery](runbooks/recovery.md) and [performance](runbooks/performance.md).
