...
export const PERMISSIONS = {
  ...
  // Seeing the photo of someone's written journal is its own decision, separate from reading the
  // typed answers: handwriting is more personal, and often mentions other people (docs/06 row 21a).
  'journal.proof.view': { module: 'journal', description: 'View journal proof photos', sensitive: true, pastoral: true, scopes: GB },
  'journal.proof.manage': { module: 'journal', description: 'Remove a journal proof photo', sensitive: true, pastoral: true, scopes: G },
...
export const ROLES = {
  ...
  primary_leader: {
    ...
    permissions: [
      ...
      direct('journal.proof.view'), direct('journal.review'), direct('journal.proxy_submit'), 'journal.excuse',
